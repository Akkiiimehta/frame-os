    ...
    <header style={{position:"sticky",top:0,zIndex:40,height:"var(--header-h)",background:"rgba(18,18,22,.96)",backdropFilter:"blur(18px)",WebkitBackdropFilter:"blur(18px)",borderBottom:"1px solid rgba(255,255,255,.09)",display:"flex",alignItems:"center",gap:14}} className="hpad" id="hdr">
      <style>{`#hdr{padding:0 28px;}`}</style>
          ...
          <div style={{display:"flex",alignItems:"center",gap:5}}>
            <button onClick={()=>setShowSearch(true)} title="Global search " style={{display:"flex",alignItems:"center",gap:7,height:32,background:"var(--bg4)",border:"1px solid var(--border)",borderRadius:8,cursor:"pointer",color:"var(--text3)",padding:"0 11px",flexShrink:0,transition:"all .15s"}} onMouseEnter={e=>{e.currentTarget.style.borderColor="var(--border2)";e.currentTarget.style.color="var(--text2)";}} onMouseLeave={e=>{e.currentTarget.style.borderColor="var(--border)";e.currentTarget.style.color="var(--text3)";}}>
